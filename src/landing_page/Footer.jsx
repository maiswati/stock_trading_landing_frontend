...
const Footer = () => {
  return (
    ...
    <div className='container mt-5 '>
      <div className="row">
        <div className="col-3">
          <img className='mb-4' src={logo} alt="logo" style={{width:"45%"}}/>
          <p>@ 2010-2024, Not Zerodha Broking Ltd. <br /> All rights reserved.</p>
          <div className='d-flex gap-2'>
            <i class="fa-brands fa-twitter" style={{color: "#626164"}}></i>
            <i class="fa-brands fa-square-facebook" style={{color: "#626164"}}></i>
            <i class="fa-brands fa-instagram" style={{color: "#626164"}}></i>
            <i class="fa-brands fa-linkedin-in" style={{color: "#626164"}}></i>
            <i class="fa-brands fa-telegram" style={{color: "#626164"}}></i>
          </div>
        </div>
        <div className="col-3">
